...
@EClassifierNodeProcessorFactory(classifierID = ArchitecturePackage.PERSON_ACTOR)
public class PersonActorProcessorFactory {

	private Context context;

	public PersonActorProcessorFactory(Context context) {
