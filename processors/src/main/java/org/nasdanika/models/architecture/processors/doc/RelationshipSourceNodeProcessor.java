...
public class RelationshipSourceNodeProcessor<T extends RelationshipSource> extends DocumentedNamedConnectionSourceNodeProcessor<T> implements RelationshipSourceNodeProcessorMixIn {
