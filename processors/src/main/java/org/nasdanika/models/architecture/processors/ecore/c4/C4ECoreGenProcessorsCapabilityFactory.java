...
public class C4ECoreGenProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new C4EcoreGenProcessorsFactory(requirement.requirement().context()))));
	}
