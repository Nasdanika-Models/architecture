...
@EClassifierNodeProcessorFactory(classifierID = ArchitecturePackage.ARCHITECTURE_DESCRIPTION_ELEMENT)
public class ArchitectureDescriptionElementProcessorFactory {

	private Context context;

	public ArchitectureDescriptionElementProcessorFactory(Context context) {
