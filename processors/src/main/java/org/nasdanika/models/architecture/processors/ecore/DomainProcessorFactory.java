...
@EClassifierNodeProcessorFactory(classifierID = ArchitecturePackage.DOMAIN)
public class DomainProcessorFactory {

	private Context context;

	public DomainProcessorFactory(Context context) {
