...
@EClassifierNodeProcessorFactory(classifierID = ArchitecturePackage.COMPOSITE_RELATIONSHIP_SOURCE)
public class CompositeRelationshipSourceProcessorFactory {

	private Context context;

	public CompositeRelationshipSourceProcessorFactory(Context context) {
