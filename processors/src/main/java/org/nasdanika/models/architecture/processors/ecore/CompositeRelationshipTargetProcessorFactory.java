...
@EClassifierNodeProcessorFactory(classifierID = ArchitecturePackage.COMPOSITE_RELATIONSHIP_TARGET)
public class CompositeRelationshipTargetProcessorFactory {

	private Context context;

	public CompositeRelationshipTargetProcessorFactory(Context context) {
